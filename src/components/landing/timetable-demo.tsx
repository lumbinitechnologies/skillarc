...
const scheduleStates = [
  { id: "plan", label: "Plan the week", message: "Move sections into place before publishing.", rows: [["Mon 09:00", "CS-302", "Room 304", "Dr. Roy"], ["Mon 11:00", "DBMS", "Room 212", "Prof. Mehta"], ["Tue 10:00", "Data Analytics", "Lab 2", "Dr. Khan"]] },
  { id: "check", label: "Check for clashes", message: "SkillArc surfaces conflicts before they reach staff or students.", rows: [["Mon 09:00", "CS-302", "Room 304", "No clash"], ["Mon 11:00", "DBMS", "Room 212", "No clash"], ["Tue 10:00", "Data Analytics", "Lab 2", "Review"]] },
  { id: "publish", label: "Publish the timetable", message: "Save, print, and share the finished schedule with the people who need it.", rows: [["Mon 09:00", "CS-302", "Room 304", "Published"], ["Mon 11:00", "DBMS", "Room 212", "Published"], ["Tue 10:00", "Data Analytics", "Lab 2", "Published"]] },
]
    ...
    <section className="bg-[#14234B] px-5 py-20 text-white sm:px-8 lg:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-center lg:gap-20">
          <div>
            <h2 className="mt-0 text-4xl font-bold tracking-[-0.05em] sm:text-5xl">Timetables your teams can trust.</h2>
          ...
          <ProductWindow title="Timetable builder" label="Illustrative workspace" accent="navy">
            <AnimatePresence mode="wait"><motion.div key={active.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.22 }}>
              <div><p className="text-sm font-semibold text-[#6D8498]">Semester timetable</p><h3 className="mt-1 text-2xl font-bold text-[#14234B]">{active.message}</h3></div>
