        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="pointer-events-auto relative flex h-[calc(100vh-140px)] max-h-[580px] w-full flex-col overflow-hidden rounded-[28px] border border-slate-200/80 bg-white/95 shadow-2xl backdrop-blur-xl sm:h-[550px] sm:w-[380px]"
            >
