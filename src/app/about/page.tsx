...
import { MarketingShell, SoftCard } from "@/components/landing/marketing-ui"
...
export default function AboutPage() {
  return (
    <MarketingShell>
      <main>
        <section className="relative overflow-hidden bg-white px-5 py-20 sm:px-8 lg:py-28"><div className="absolute right-[-9rem] top-[-10rem] h-[34rem] w-[34rem] rounded-full bg-[#FBECE5] blur-3xl" aria-hidden="true" /><div className="relative mx-auto max-w-7xl"><h1 className="mt-0 max-w-4xl text-5xl font-bold leading-[1.04] tracking-[-0.055em] text-[#14234B] sm:text-6xl lg:text-7xl">Built for better university experiences.</h1><p className="mt-7 max-w-2xl text-lg leading-8 text-[#58718B]">SkillArc helps universities spend less time reconciling disconnected processes and more time supporting students.</p></div></section>
