...
export default function AboutPage() {
  ...
  return (
    <div className="editorial-page min-h-screen bg-[#0A0A0A] text-[#F4F4F0] antialiased overflow-x-hidden selection:bg-[#FF5500]/20 selection:text-[#FF5500] font-['Space_Grotesk',sans-serif]">
      <LandingNavbar />
