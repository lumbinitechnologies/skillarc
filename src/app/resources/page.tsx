...
export default function ResourcesPage() {
  return (
    <MarketingShell>
      <main>
        <section className="relative overflow-hidden bg-[#14234B] px-5 py-20 text-white sm:px-8 lg:py-28"><div className="absolute left-[-8rem] top-[-9rem] h-[30rem] w-[30rem] rounded-full bg-[#31547A]/50 blur-3xl" aria-hidden="true" /><div className="relative mx-auto max-w-7xl"><h1 className="mt-0 max-w-4xl text-5xl font-bold leading-[1.04] tracking-[-0.055em] sm:text-6xl lg:text-7xl">Clear answers for university teams.</h1><p className="mt-7 max-w-2xl text-lg leading-8 text-[#D6E3EC]">Start with the overview that matches your role, then explore the workflows behind a more connected student journey.</p></div></section>
